...
final class TraceEnrichingChannel implements Channel {
    ...
    private ListenableFuture<Response> executeInternal(Endpoint endpoint, Request request) {
        ...
        Tracers.addTracingHeaders(requestBuilder, TraceEnrichingHelper.INSTANCE);
    ...
    private enum TraceEnrichingHelper implements TracingHeadersEnrichingFunction<Request.Builder> {
        INSTANCE;
